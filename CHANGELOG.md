...
- test: set timeout of pytest_tornado to 20 seconds to avoid false CI failed [#321](https://github.com/voila-dashboards/voila/pull/321) ([@maartenbreddels](https://github.com/maartenbreddels))
